...
export const AUDIT_LOG = [
  ...
  // ── Broader per-event coverage — most events now have at least one audit
  // entry, so the Audit Trail tab has real activity to show in general.
  { id: 'AUD-016', timestamp: '2026-07-02T07:02:00Z', actor: 'System',    action: 'Claims Extracted',      studio: 'gov',     artifact: 'DIAN-4821',        risk: 'low',      outcome: 'success',   hash: 'a2b3c4d5', prevHash: 'c7d8e9f0' },
  { id: 'AUD-017', timestamp: '2026-06-17T11:05:00Z', actor: 'Jordan T.', action: 'Connector Flagged',     studio: 'gov',     artifact: 'CONN-SF-001',      risk: 'high',     outcome: 'pending',   hash: 'e4f5a6b7', prevHash: 'a2b3c4d5' },
  { id: 'AUD-018', timestamp: '2026-06-17T06:01:30Z', actor: 'System',    action: 'Schema Mismatch Detected', studio: 'cross', artifact: 'CHAIN-0712',       risk: 'high',     outcome: 'blocked',   hash: 'c6d7e8f9', prevHash: 'e4f5a6b7' },
  { id: 'AUD-019', timestamp: '2026-06-10T09:05:00Z', actor: 'System',    action: 'Contract Expiry Warning', studio: 'gov',   artifact: 'KC-2204',          risk: 'low',      outcome: 'pending',   hash: 'a8b9c0d1', prevHash: 'c6d7e8f9' },
  { id: 'AUD-020', timestamp: '2026-06-16T13:05:00Z', actor: 'System',    action: 'Conflict Flagged',      studio: 'gov',     artifact: 'CONF-GE-004',      risk: 'medium',   outcome: 'pending',   hash: 'e0f1a2b3', prevHash: 'a8b9c0d1' },
  { id: 'AUD-021', timestamp: '2026-06-18T09:05:00Z', actor: 'System',    action: 'Recertification Window Opened', studio: 'gov', artifact: 'RECERT-Q2-2026', risk: 'low',    outcome: 'scheduled', hash: 'c2d3e4f5', prevHash: 'e0f1a2b3' },
  { id: 'AUD-022', timestamp: '2026-06-30T06:00:00Z', actor: 'System',    action: 'Report Generated',      studio: 'agentic', artifact: 'RPT-ADVISOR-W24',  risk: 'none',     outcome: 'success',   hash: 'a4b5c6d7', prevHash: 'c2d3e4f5' },
  { id: 'AUD-023', timestamp: '2026-06-17T09:05:00Z', actor: 'Sam R.',    action: 'Entity Conflict Flagged', studio: 'data',  artifact: 'ENT-DEDUP-0441',   risk: 'medium',   outcome: 'pending',   hash: 'e6f7a8b9', prevHash: 'a4b5c6d7' },
  { id: 'AUD-024', timestamp: '2026-06-30T14:22:00Z', actor: 'Jordan T.', action: 'Question Routed',       studio: 'gov',     artifact: 'MSG-0441',         risk: 'none',     outcome: 'success',   hash: 'c8d9e0f1', prevHash: 'e6f7a8b9' },
  { id: 'AUD-025', timestamp: '2026-07-01T08:45:00Z', actor: 'Morgan C.', action: 'Attestation Requested', studio: 'agentic', artifact: 'MSG-0512',         risk: 'low',      outcome: 'pending',   hash: 'a0b1c2d3', prevHash: 'c8d9e0f1' },
  { id: 'AUD-026', timestamp: '2026-07-02T07:06:05Z', actor: 'System',    action: 'HTL Handoff Triggered', studio: 'agentic', artifact: 'LEAD-8834',        risk: 'low',      outcome: 'success',   hash: 'e2f3a4b5', prevHash: 'a0b1c2d3' },
  { id: 'AUD-027', timestamp: '2026-07-02T07:30:00Z', actor: 'Quinn S.',  action: 'Broadcast Sent',        studio: 'gov',     artifact: 'MSG-0601',         risk: 'none',     outcome: 'success',   hash: 'c4d5e6f7', prevHash: 'e2f3a4b5' },
  { id: 'AUD-028', timestamp: '2026-07-02T10:00:00Z', actor: 'System',    action: 'HITL Approval Gate Created', studio: 'client', artifact: 'WEBCHAT-88312', risk: 'medium',  outcome: 'paused',    hash: 'a6b7c8d9', prevHash: 'c4d5e6f7' },
  { id: 'AUD-029', timestamp: '2026-07-02T10:00:00Z', actor: 'System',    action: 'GE-COMM Block Triggered', studio: 'client', artifact: 'RETENTION-44201',  risk: 'high',     outcome: 'blocked',   hash: 'e8f9a0b1', prevHash: 'a6b7c8d9' },
  { id: 'AUD-030', timestamp: '2026-07-02T09:48:05Z', actor: 'System',    action: 'HTL Handoff Completed', studio: 'client',  artifact: 'VCARD-91044',      risk: 'low',      outcome: 'success',   hash: 'c0d1e2f3', prevHash: 'e8f9a0b1' },
  { id: 'AUD-031', timestamp: '2026-07-02T09:55:10Z', actor: 'System',    action: 'Council Escalation — GE-COMP', studio: 'client', artifact: 'VOICE-22819', risk: 'critical', outcome: 'escalated', hash: 'a2b3c4d6', prevHash: 'c0d1e2f3' },
]
...
export const ATTESTATIONS = [
  ...
  // ── Governance-studio coverage — every gov event has at least one attestation
  // example, so the Attestation tab (Governance-only in the Inbox view) always
  // has real content to show, not an empty state.
  {
    id: 'ATT-004',
    from: 'p1', to: 'p14',
    linkedEvent: 'EVT-001',
    status: 'pending',
    requestedDate: '2026-07-02T08:05:00Z',
    question: 'Please confirm the two GE-FIN conflicts on the DIAN Financial Policy intake were resolved per the documented precedence rule before this commits to the Truth Registry.',
    response: null,
    auditHash: 'e5f6a7b8',
  },
  {
    ...
    linkedEvent: 'EVT-005',
    status: 'pending',
    requestedDate: '2026-06-17T11:00:00Z',
    question: 'Attest that the Salesforce OAuth renewal plan follows change-management procedure and that all 57 dependent workflows have been notified of the maintenance window.',
    response: null,
    auditHash: 'a1b2c3d4',
  },
  {
    ...
    linkedEvent: 'EVT-006',
    status: 'pending',
    requestedDate: '2026-06-17T09:00:00Z',
    question: "Attest that the interest rate sensitivity threshold decision on KBU-4490 is consistent with the Q1 2026 Risk Framework update and doesn't conflict with the Financial Policy Manual v12.",
    response: null,
    auditHash: 'c9d0e1f2',
  },
  {
    ...
    linkedEvent: 'EVT-009',
    status: 'verified',
    requestedDate: '2026-06-10T09:00:00Z',
    question: "Confirm ComplianceBot's Truth Registry read-access contract renewal terms match its current partition scope with no privilege expansion.",
    response: 'Confirmed — renewal terms are identical to the existing contract. No scope change.',
    auditHash: 'e9f0a1b2',
  },
  {
    id: 'ATT-008',
    ...
    linkedEvent: 'EVT-011',
    status: 'verified',
    requestedDate: '2026-06-14T10:00:00Z',
    question: 'Attest that the regional multiplier correction (1.15 vs model-predicted 1.12) was validated against the source pricing document before being used to retrain the model.',
    response: 'Verified against Q2 2026 pricing model documentation. 1.15 is correct.',
    auditHash: 'a5b6c7d8',
  },
  {
    id: 'ATT-009',
    ...
    linkedEvent: 'EVT-012',
    status: 'pending',
    requestedDate: '2026-06-16T13:00:00Z',
    question: 'Attest which source (0.85 or 0.90) is authoritative for GE-COMP-004 and confirm ComplianceBot should adopt it platform-wide.',
    response: null,
    auditHash: 'c1d2e3f4',
  },
  {
    ...
    linkedEvent: 'EVT-014',
    status: 'verified',
    requestedDate: '2026-06-12T09:00:00Z',
    question: 'Confirm the GE-FIN budget envelope projection (8% overage) has been reviewed and no corrective action is required this period.',
    response: 'Reviewed. Overage is within tolerance; no action needed before quarter close.',
    auditHash: 'a9b0c1d2',
  },
  {
    id: 'ATT-011',
    ...
    linkedEvent: 'EVT-015',
    status: 'pending',
    requestedDate: '2026-06-18T09:00:00Z',
    question: 'Attest that the scope of the Q2 access recertification (24 users, 3 partitions) is complete and no partitions were omitted.',
    response: null,
    auditHash: 'c5d6e7f8',
  },
  {
    ...
    linkedEvent: 'EVT-019',
    status: 'verified',
    requestedDate: '2026-06-30T15:00:00Z',
    question: "Confirm the guidance given on the GE-FIN-001 vs GE-FIN-007 conflict was consistent with last quarter's review outcome.",
    response: 'Confirmed — Source B was already the accepted resolution from Q1 review.',
    auditHash: 'e3f4a5b6',
  },
  {
    id: 'ATT-013',
    ...
    linkedEvent: 'EVT-022',
    status: 'verified',
    requestedDate: '2026-07-02T08:00:00Z',
    question: 'Attest that the Q2 governance posture summary (Watch status, KCON and promotion-rate items) was accurately represented in the platform-wide broadcast.',
    response: 'Confirmed accurate — reviewed against the underlying KCON and promotion-rate dashboards before sending.',
    auditHash: 'c7d8e9f0',
  },
]
...
export const COMMENT_THREADS = {
  ...
  // ── Broader coverage — most events now have a thread example, so Thread
  // tab has real content to show across the board, not just a handful of cases.
  'EVT-002': {
    status: 'open',
    initiatorId: 'p10',
    participants: ['p10', 'p1'],
    comments: [
      { id: 'CMT-008', authorId: 'p10', timestamp: '2026-06-17T09:15:00Z',
        body: 'Confidence came in at 0.71 — just under our 0.85 auto-send bar. Want me to loop in Legal before you approve the send?', mentions: [] },
      { id: 'CMT-009', authorId: 'p1', timestamp: '2026-06-17T09:20:00Z',
        body: "No need — this is a forecast summary to an existing partner contact. Approving.", mentions: [] },
    ],
  },
  'EVT-003': {
    status: 'closed',
    ...
    participants: ['p5', 'p3'],
    comments: [
      { id: 'CMT-010', authorId: 'p5', timestamp: '2026-06-17T07:20:00Z',
        body: 'Docs look validated on my end — ready for DIAN parsing whenever you approve.', mentions: [] },
      { id: 'CMT-011', authorId: 'p3', timestamp: '2026-06-17T07:31:00Z',
        body: 'Approving now, thanks for the quick turnaround.', mentions: [] },
    ],
  },
  'EVT-004': {
    status: 'open',
    ...
    participants: ['p7', 'p1'],
    comments: [
      { id: 'CMT-012', authorId: 'p7', timestamp: '2026-06-17T08:05:00Z',
        body: 'First approval logged. Standing by for your second sign-off — this is time-boxed to 4 hours per policy.', mentions: [] },
      { id: 'CMT-013', authorId: 'p1', timestamp: '2026-06-17T08:20:00Z',
        body: 'Reviewing the incident ticket now, will approve within the hour.', mentions: [] },
    ],
  },
  'EVT-006': {
    status: 'open',
    ...
    participants: ['p14', 'p1'],
    comments: [
      { id: 'CMT-014', authorId: 'p14', timestamp: '2026-06-17T08:50:00Z',
        body: "Compliance flagged this as outside Marcus H.'s sign-off — needs exec-level authority given the Q1 Risk Framework conflict.", mentions: [] },
      { id: 'CMT-015', authorId: 'p1', timestamp: '2026-06-17T09:05:00Z',
        body: 'Reviewing both sources now, will decide by EOD.', mentions: [] },
    ],
  },
  'EVT-007': {
    status: 'open',
    ...
    participants: ['p9', 'p10'],
    comments: [
      { id: 'CMT-016', authorId: 'p9', timestamp: '2026-06-17T06:05:00Z',
        body: "QuoteBot's stalled on the schema mismatch — DIAN parser still expects v45 fields.", mentions: [] },
      { id: 'CMT-017', authorId: 'p10', timestamp: '2026-06-17T06:15:00Z',
        body: 'Applying the schema patch now, should unblock the pipeline in a few minutes.', mentions: [] },
    ],
  },
  'EVT-008': {
    status: 'open',
    ...
    participants: ['p6', 'p9'],
    comments: [
      { id: 'CMT-018', authorId: 'p6', timestamp: '2026-06-25T10:00:00Z',
        body: 'Same issue is affecting SalesForecastPA too — want to coordinate the Truth v3.1 migration together?', mentions: [] },
      { id: 'CMT-019', authorId: 'p9', timestamp: '2026-06-25T10:12:00Z',
        body: "Good call, I'll update the pin for both specs today.", mentions: [] },
    ],
  },
  'EVT-009': {
    status: 'closed',
    ...
    participants: ['p4', 'p2'],
    comments: [
      { id: 'CMT-020', authorId: 'p4', timestamp: '2026-06-10T08:50:00Z',
        body: "ComplianceBot's TR access contract expires in 18 days — should we renew as-is or tighten scope?", mentions: [] },
      { id: 'CMT-021', authorId: 'p2', timestamp: '2026-06-10T09:10:00Z',
        body: 'Renew as-is, no policy changes since last cycle.', mentions: [] },
    ],
  },
  'EVT-010': {
    status: 'open',
    ...
    participants: ['p13', 'p2'],
    comments: [
      { id: 'CMT-022', authorId: 'p13', timestamp: '2026-06-28T09:00:00Z',
        body: 'This has been sitting in KCON review for over a week — any blocker on your end?', mentions: [] },
      { id: 'CMT-023', authorId: 'p2', timestamp: '2026-06-28T09:30:00Z',
        body: 'Just catching up now, will resolve today.', mentions: [] },
    ],
  },
  'EVT-011': {
    status: 'closed',
    ...
    participants: ['p9', 'p1'],
    comments: [
      { id: 'CMT-024', authorId: 'p9', timestamp: '2026-06-14T09:45:00Z',
        body: "Ground truth came back at 1.15, model predicted 1.12 — confirming with you since Luis is OOO.", mentions: [] },
      { id: 'CMT-025', authorId: 'p1', timestamp: '2026-06-14T10:05:00Z',
        body: 'Confirmed, 1.15 is correct per the pricing doc.', mentions: [] },
    ],
  },
  'EVT-013': {
    status: 'closed',
    ...
    participants: ['p16', 'p5'],
    comments: [
      { id: 'CMT-026', authorId: 'p16', timestamp: '2026-06-15T09:00:00Z',
        body: 'Scheduling the monthly re-index for the usual off-peak window unless you want changes.', mentions: [] },
      { id: 'CMT-027', authorId: 'p5', timestamp: '2026-06-15T09:10:00Z',
        body: 'That works, go ahead and auto-approve.', mentions: [] },
    ],
  },
  'EVT-014': {
    status: 'closed',
    ...
    participants: ['p8', 'p2'],
    comments: [
      { id: 'CMT-028', authorId: 'p8', timestamp: '2026-06-12T08:50:00Z',
        body: "Budget's at 62% with 2 weeks left — flagging in case we need to slow spend.", mentions: [] },
      { id: 'CMT-029', authorId: 'p2', timestamp: '2026-06-12T09:05:00Z',
        body: 'Projected overage is within tolerance, just acknowledge for now.', mentions: [] },
    ],
  },
  'EVT-015': {
    status: 'open',
    ...
    participants: ['p4', 'p1'],
    comments: [
      { id: 'CMT-030', authorId: 'p4', timestamp: '2026-06-18T08:50:00Z',
        body: '24 users need recert across 3 partitions this cycle — same scope as Q1.', mentions: [] },
      { id: 'CMT-031', authorId: 'p1', timestamp: '2026-06-18T09:05:00Z',
        body: 'Opening the recertification window now.', mentions: [] },
    ],
  },
  'EVT-016': {
    status: 'closed',
    ...
    participants: ['p10', 'p6'],
    comments: [
      { id: 'CMT-032', authorId: 'p10', timestamp: '2026-06-24T09:00:00Z',
        body: '94% resolution rate again this week — nice trend. Nothing needed from us here.', mentions: [] },
      { id: 'CMT-033', authorId: 'p6', timestamp: '2026-06-24T09:10:00Z',
        body: 'Agreed, acknowledging.', mentions: [] },
    ],
  },
  'EVT-017': {
    status: 'open',
    ...
    participants: ['p7', 'p3'],
    comments: [
      { id: 'CMT-034', authorId: 'p7', timestamp: '2026-06-17T09:05:00Z',
        body: '34 SSN patterns flagged in the raw upload — this needs manual review before redaction.', mentions: [] },
      { id: 'CMT-035', authorId: 'p3', timestamp: '2026-06-17T09:20:00Z',
        body: 'On it, reviewing the flagged fields now.', mentions: [] },
    ],
  },
  'EVT-018': {
    status: 'open',
    ...
    participants: ['p16', 'p5'],
    comments: [
      { id: 'CMT-036', authorId: 'p16', timestamp: '2026-06-20T10:00:00Z',
        body: '68% confidence these are the same entity — I lean toward merge given the address overlap.', mentions: [] },
      { id: 'CMT-037', authorId: 'p5', timestamp: '2026-06-20T10:15:00Z',
        body: "Agreed, let's merge and keep the audit trail on the decision.", mentions: [] },
    ],
  },
  'EVT-019': {
    status: 'closed',
    ...
    participants: ['p4', 'p2'],
    comments: [
      { id: 'CMT-038', authorId: 'p2', timestamp: '2026-06-30T15:00:00Z',
        body: "Source B is the one that matches this quarter's compliance update — go with that.", mentions: [] },
    ],
  },
  'EVT-020': {
    status: 'open',
    ...
    participants: ['p10', 'p6'],
    comments: [
      { id: 'CMT-039', authorId: 'p6', timestamp: '2026-07-01T09:00:00Z',
        body: "Taking ownership of the migration now, will push today and let you know once it's done.", mentions: [] },
    ],
  },
  'EVT-021': {
    status: 'open',
    ...
    participants: ['p10', 'p1'],
    comments: [
      { id: 'CMT-040', authorId: 'p10', timestamp: '2026-07-02T07:10:00Z',
        body: "94/100 lead score — this one's worth a personal call today given the deal size.", mentions: [] },
      { id: 'CMT-041', authorId: 'p1', timestamp: '2026-07-02T07:20:00Z',
        body: 'On it, reaching out this afternoon.', mentions: [] },
    ],
  },
  'EVT-C001': {
    status: 'open',
    ...
    participants: ['p6', 'p10'],
    comments: [
      { id: 'CMT-042', authorId: 'p6', timestamp: '2026-07-02T10:00:00Z',
        body: "Enterprise pricing needs a manual quote — Canon doesn't cover 500-seat deployments yet.", mentions: [] },
      { id: 'CMT-043', authorId: 'p10', timestamp: '2026-07-02T10:05:00Z',
        body: "I'll prep a custom quote and get back to the prospect within the hour.", mentions: [] },
    ],
  },
  'EVT-C002': {
    status: 'open',
    ...
    participants: ['p6', 'p1'],
    comments: [
      { id: 'CMT-044', authorId: 'p6', timestamp: '2026-07-02T10:00:00Z',
        body: "Customer's frustrated — two open tickets sitting 8+ days. Retention script alone won't cut it.", mentions: [] },
      { id: 'CMT-045', authorId: 'p1', timestamp: '2026-07-02T10:08:00Z',
        body: "Agreed, I'll personally reach out before responding to the cancellation request.", mentions: [] },
    ],
  },
  'EVT-C003': {
    status: 'closed',
    ...
    participants: ['p10', 'p6'],
    comments: [
      { id: 'CMT-046', authorId: 'p10', timestamp: '2026-07-02T09:50:00Z',
        body: 'Warm prospect asking about Data Studio governance — good fit for the enterprise team.', mentions: [] },
      { id: 'CMT-047', authorId: 'p6', timestamp: '2026-07-02T09:55:00Z',
        body: 'Reassigning to field sales now.', mentions: [] },
    ],
  },
  'EVT-C004': {
    status: 'open',
    ...
    participants: ['p7', 'p1'],
    comments: [
      { id: 'CMT-048', authorId: 'p7', timestamp: '2026-07-02T09:56:00Z',
        body: 'Vulnerability indicators confirmed by the voice model — this needs immediate human handling per policy.', mentions: [] },
      { id: 'CMT-049', authorId: 'p1', timestamp: '2026-07-02T09:57:00Z',
        body: 'Taking the call now.', mentions: [] },
    ],
  },
}
